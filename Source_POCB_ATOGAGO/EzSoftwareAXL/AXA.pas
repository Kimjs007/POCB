...
function AxaiExternalStopADC(lModuleNo : LongInt) : DWord; stdcall;
    ...
    //                  : FIFO_DATA_FULL(6)
    //==================================================================================================//    
function AxaiExternalReadFifoStatus(lModuleNo : LongInt; upStatus : PDWord) : DWord; stdcall;
...
function AxaiExternalReadVoltage(lModuleNo : LongInt; lSize : LongInt; lpChannelPos : PLongInt; lDataSize : LongInt; lBuffSize : LongInt; lStartDataPos : LongInt; dpVolt : PDouble; lpRetDataSize : PLongInt; upStatus : PDWord) : DWord; stdcall;
